...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private lazy var serviceContainer: ServiceContainer = {
        ...
        container.networkService = NetworkingService()
        container.localStorageService = localStorageService
        return container
    }()
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let tabBarController = PlacesTabBarController()
        tabBarController.viewControllers = [mapModule, placesListNavigationController]
